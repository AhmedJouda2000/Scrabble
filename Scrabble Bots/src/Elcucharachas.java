...
public class Elcucharachas implements BotAPI {
	...
	Elcucharachas(PlayerAPI me, OpponentAPI opponent, BoardAPI board, UserInterfaceAPI ui, DictionaryAPI dictionary) {
		this.me = me;
	...
	//returns the command for this turn 
	public String getCommand() {
		if (turnCount == 0) {
			turnCount++;
			return "NAME Elcucharachas";
		}
		String command;
		//exchange tile if its a blank
	...
	//check where we can place words
	...
	//puts the command in the correct form
	...
	//helper function to generate all sub permutations of each permutation
	...
	//checks if a word is valid using the dictionary
